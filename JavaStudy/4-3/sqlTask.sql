...
-- [
    ...
    FROM stock_table
    LEFT JOIN store_table ON stock_table.store_code = store_table.store_code
    LEFT JOIN goods_table ON stock_table.goods_code = goods_table.goods_code
    ]
 
-- 4. 商品テーブルから全商品の単価の平均値を抽出しなさい。
-- [
    SELECT ROUND(AVG(price)) AS 単価平均
    FROM goods_table
    ]
...
-- [
    ...
    VALUES('M001', 'マフラー', '4500', '2021-01-06')
    ;
    ]
...
-- [
    ...
    VALUES('S987', 'EA01', '10', '2021-01-06')
    ;
    ]
