...
public abstract class BaseServlet extends HttpServlet {
    ...
    protected boolean validateLogin(final HttpServletRequest request) throws IOException {
        ...
        try {
            ...
            // ←ここへ記述
        	EmployeeBean info = new EmployeeBean(reqEmpId);
        	ExecuteCase exec = ExecuteCase.FIND_BY_EMPID;
        	responseBean = ems.getEmployeeData(exec, info);
            ...
            if (Objects.nonNull(resEmployeeBean)) {
                ...
                System.out.println(" ====resEmployeeBean.getPassword = " + resEmployeeBean.getPassword());
                System.out.println(" ====hashPassword = " + hashPassword);

                if (resEmployeeBean.getPassword().equals(hashPassword)) {
//                if (resEmployeeBean.getPassword().equals("0000")) {
            ...
            if (Objects.isNull(this.destinationTarget)) {
            	System.out.println( "destinationTarget ======" + destinationTarget);
